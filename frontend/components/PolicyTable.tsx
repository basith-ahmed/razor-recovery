  ...
  return (
    <div className="bg-white border border-slate-200 rounded-lg p-5 mb-6">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-md font-semibold text-slate-900">Config-Driven Recovery Policy Engine</h3>
          <p className="text-xs text-slate-400">
            Live policy rules fetched directly from <code className="text-blue-700">backend/src/domain/policy.json</code>
          </p>
        </div>
          ...
          <tbody className="divide-y divide-slate-200/60">
            {rules.map((rule, idx) => (
              <tr key={idx} className="hover:bg-slate-100/40">
                ...
                <td className="p-3 font-mono text-[11px] text-amber-800">
